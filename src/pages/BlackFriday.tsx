...
export default function BlackFriday() {
  ...
  return (
    <div className="font-outfit antialiased bg-white text-[#0a0a0a] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-white/70 text-sm">
            ...
            <a href="#que-hacemos" className="hover:text-[#fc6c04] transition">Que hacemos</a>
      ...
      <section className="relative min-h-screen flex items-center bg-[#0a0a0a] overflow-hidden pt-20">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-white/60 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed">
            Estrategia integral para convertir tu audiencia en una maquina de ventas
      ...
      {/* What We Do For You */}
      <section id="que-hacemos" className="bg-white py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6">
          <SectionTitle subtitle="Que hacemos por ti" title="Todo lo que necesitas para vender mas" />
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            <motion.div variants={fadeUp}>
              <h3 className="text-lg font-bold mb-4">Servicios incluidos</h3>
              <div className="space-y-3 mb-8">
                {[
                  { icon: Target, label: "Estrategia de lanzamiento completa y personalizada" },
                  { icon: Video, label: "Produccion de contenido para reels, stories y ads" },
                  { icon: MessageCircle, label: "Copywriting persuasivo para cada etapa del funnel" },
                  { icon: BarChart3, label: "Gestion de campanas de publicidad pagada" },
                  { icon: Mail, label: "Automatizacion de email marketing y secuencias" },
                  { icon: Brain, label: "Analisis de datos y optimizacion en tiempo real" },
                ].map((item, i) => (
            ...
            <motion.div variants={fadeUp}>
              <h3 className="text-lg font-bold mb-4">Nichos con los que trabajamos</h3>
              <div className="flex flex-wrap gap-2 mb-8">
                {["Desarrollo personal", "Salud y bienestar", "Finanzas", "Negocios digitales", "Coaching", "Educacion online", "Fitness", "Nutricion", "Espiritualidad", "Marketing"].map((tag) => (
                  <span key={tag} className="px-3 py-1.5 bg-[#f5f0eb] text-[#555] rounded-full text-sm">{tag}</span>
                ))}
              </div>

              <h3 className="text-lg font-bold mb-4">Resultados que generamos</h3>
              <ul className="space-y-2">
                {[
                  "Lanzamientos de 6 y 7 cifras en menos de 7 dias",
                  "Tasas de conversion 3x superiores al promedio del mercado",
                  "Construccion de comunidades fieles y comprometidas",
                  "Sistemas de venta automatizados y escalables",
                  "Posicionamiento como autoridad en tu nicho",
                ].map((item, i) => (
            ...
            {[
              {
                ...
                desc: "Construir anticipacion y deseo. Contenido de alto valor que prepara la audiencia para la oferta.",
            ...
            <motion.div variants={fadeUp} className="bg-white rounded-2xl p-8 border border-[#eee]">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-[#fafafa] rounded-xl">
                  ...
                  <p className="text-sm text-[#666]">Contenido exclusivo, sesion grupal en vivo, comunidad VIP por 90 dias, material complementario.</p>
                </div>
                <div className="p-4 bg-[#fafafa] rounded-xl">
                ...
                <div className="p-4 bg-[#fafafa] rounded-xl">
                  <p className="font-bold text-[#0a0a0a] mb-1">Garantia de satisfaccion</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <TimelineItem
              ...
              description="Contenido enfocado en hacer que la audiencia identifique sus problemas y necesidades."
              items={[
                "Reels de alto impacto que conecten con el dolor de tu audiencia",
                "Stories: Encuestas y preguntas para generar interaccion",
                "Carruseles educativos que posicionen tu autoridad",
                "Testimonios de alumnos transformados (video corto)",
                "Live semanal: Q&A sobre tu area de expertise",
              ]}
              color="bg-[#fc6c04]"
            />
            <TimelineItem
              ...
              items={[
                ...
                "Behind the scenes: preparando la oferta especial",
            ...
            <TimelineItem
              ...
              items={[
                ...
                "Planificar upsell para el siguiente lanzamiento",
              ]}
              color="bg-[#00983A]"
            />
          </motion.div>
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-12">
              ...
              <p className="text-white/50 max-w-2xl mx-auto">
                Basado en nuestra experiencia con mas de 100 creadores y sus metricas reales.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {[
                { value: "100+", label: "Expertos atendidos", sub: "En toda America Latina" },
            ...
            <motion.div variants={fadeUp} className="bg-gradient-to-br from-[#fc6c04]/10 to-transparent border border-[#fc6c04]/20 rounded-2xl p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  "Trabajamos con los nichos mas importantes: desarrollo personal, salud, finanzas y educacion",
      ...
      <footer className="bg-[#0a0a0a] py-8 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-xs">
            &copy; 2026 4GO Academy. Presentacion exclusiva y confidencial.
          </p>
        </div>
      </footer>
    </div>
