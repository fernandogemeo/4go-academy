...
const phases = [
  {
    id: 1, icon: ClipboardList, label: "Planejamento", weeks: "Semana 1",
    color: "#4B6BFB", border: "border-blue-200", badge: "bg-blue-100 text-blue-600", dot: "bg-blue-500",
    tasks: [
      "Definir oferta, preço e bônus exclusivos",
      "Criar a Grande Ideia e a narrativa da campanha",
      "Desenhar o funil completo de captação e vendas",
      "Preparar o calendário editorial das 8 semanas",
    ],
  },
  {
    id: 2, icon: Video, label: "Gravação", weeks: "Semanas 2–3",
    color: "#8B5CF6", border: "border-purple-200", badge: "bg-purple-100 text-purple-600", dot: "bg-purple-500",
    tasks: [
      "Gravar todos os vídeos da campanha",
      "Produzir conteúdo para reels, stories e anúncios",
      "Criar sequências de e-mail e páginas de venda",
      "Preparar materiais de prova social e depoimentos",
    ],
  },
  {
    id: 3, icon: Megaphone, label: "Captação & Antecipação", weeks: "Semanas 4–7",
    color: "#EF4444", border: "border-red-200", badge: "bg-red-100 text-red-600", dot: "bg-red-500",
    tasks: [
      "Ativar campanhas de captação de leads",
      "Publicar conteúdo de aquecimento diário",
      "Lançar lista VIP com acesso antecipado",
      "Teasers, contagens regressivas e bastidores",
      "Equipe de vendas ativa para conversão de leads",
    ],
  },
  {
    id: 4, icon: DollarSign, label: "Vendas", weeks: "Semana 8",
    color: "#F97316", border: "border-orange-200", badge: "bg-orange-100 text-orange-600", dot: "bg-orange-500",
    tasks: [
      "Abertura do carrinho — Black Friday",
      "Máxima pressão de vendas com urgência real",
      "1 reel + 3–5 stories diários + e-mail diário",
      "Live de fechamento com Perguntas e Respostas nas últimas horas",
...
const weekLabels: Record<number, { phase: string; color: string; border: string; bg: string }> = {
  1: { phase: "Planejamento", color: "text-blue-600",   border: "border-blue-300",   bg: "bg-blue-50" },
  2: { phase: "Gravação",     color: "text-purple-600", border: "border-purple-300", bg: "bg-purple-50" },
  3: { phase: "Gravação",     color: "text-purple-600", border: "border-purple-300", bg: "bg-purple-50" },
  4: { phase: "Captação",     color: "text-red-600",    border: "border-red-300",    bg: "bg-red-50" },
  5: { phase: "Antecipação",  color: "text-red-600",    border: "border-red-300",    bg: "bg-red-50" },
  6: { phase: "Antecipação",  color: "text-red-600",    border: "border-red-300",    bg: "bg-red-50" },
  7: { phase: "Antecipação",  color: "text-red-600",    border: "border-red-300",    bg: "bg-red-50" },
  8: { phase: "Vendas",       color: "text-orange-600", border: "border-orange-300", bg: "bg-orange-50" },
}

const contentItems = [
  { icon: Play,      qty: 20, label: "Reels — Os mais visualizados",    desc: "Repostar os mais visualizados com CTA da Black Friday no final", exampleVideo: "" },
  { icon: Video,     qty: 15, label: "Reels de Captação Orgânica",      desc: "Conteúdos para atrair novos leads de forma orgânica", exampleVideo: "" },
  { icon: Megaphone, qty: 10, label: "Anúncios em Vídeo",               desc: "Convite direto para a lista de espera / oferta", exampleVideo: "" },
  { icon: Image,     qty: 5,  label: "Carrosséis Criativos",            desc: "Formato carrossel para engajamento e autoridade", exampleVideo: "" },
  { icon: Target,    qty: 5,  label: "Anúncios de Inscrições Abertas",  desc: "Criativos para abertura de carrinho e conversão", exampleVideo: "" },
  { icon: FileText,  qty: 5,  label: "Criativos Estáticos",             desc: "Imagens de captação para tráfego pago", exampleVideo: "" },
]

const goalColumns = [
  { icon: Target, label: "Meta Ruim",      color: "text-yellow-600", border: "border-yellow-200", bg: "bg-yellow-50", dot: "bg-yellow-400", items: ["Faturamento: $120.000", "Leads: 20.000", "Conversão: 3%  →  600 vendas", "ROI: 6x"] },
  { icon: Star,   label: "Meta OK",        color: "text-blue-600",   border: "border-blue-200",   bg: "bg-blue-50",   dot: "bg-blue-400",   items: ["Faturamento: $240.000", "Leads: 20.000", "Conversão: 6%  →  1.200 vendas", "ROI: 11x"] },
  { icon: Flame,  label: "Meta Explosiva", color: "text-orange-600", border: "border-orange-200", bg: "bg-orange-50", dot: "bg-orange-400", items: ["Faturamento: $400.000", "Leads: 20.000", "Conversão: 10%  →  2.000 vendas", "ROI: 19x"] },
]

const materialLinks = [
  { icon: Users,           label: "Lista de Alunos",       href: "#" },
  { icon: Mail,            label: "Lista de Leads",        href: "#" },
  { icon: Link,            label: "Página de Captura",     href: "#" },
  { icon: ShoppingCart,    label: "Finalização de Compra", href: "#" },
  { icon: LayoutDashboard, label: "Dashboard de Captura",  href: "#" },
  { icon: FlaskConical,    label: "Pesquisa",              href: "#" },
  { icon: Copy,            label: "Copy dos Anúncios",     href: "#" },
  { icon: Mic,             label: "Script da Live",        href: "#" },
]

const weekPlan = [
  { week: 1, phase: "Planejamento",  color: "#4B6BFB", tasks: ["Definir oferta, preço e bônus", "Criar narrativa e Grande Ideia da campanha", "Montar funil de captação e vendas", "Preparar calendário editorial de 8 semanas"] },
  { week: 2, phase: "Gravação",      color: "#8B5CF6", tasks: ["Gravar reels de captação orgânica", "Gravar anúncios em vídeo de convite direto", "Produzir criativos estáticos e carrosséis", "Revisar roteiros e materiais"] },
  { week: 3, phase: "Gravação",      color: "#8B5CF6", tasks: ["Finalizar todos os vídeos da campanha", "Criar sequência de e-mails e páginas de venda", "Preparar materiais de prova social e depoimentos", "Configurar ferramentas de automação"] },
  { week: 4, phase: "Captação",      color: "#EF4444", tasks: ["Ativar campanhas de tráfego pago", "Publicar reels históricos com CTA da Black Friday", "Lançar lista VIP com acesso antecipado", "Iniciar disparos de API para base de leads"] },
  { week: 5, phase: "Antecipação",   color: "#EF4444", tasks: ["Continuar captação e publicar conteúdo de aquecimento", "Teasers e bastidores da oferta", "Contagens regressivas e stories de antecipação", "Equipe de vendas ativa para conversão de leads"] },
  { week: 6, phase: "Antecipação",   color: "#EF4444", tasks: ["Aumentar pressão de antecipação", "Compartilhar depoimentos e prova social", "Disparos de API com imagens para lista de alunos", "Reforçar narrativa: maior Black Friday da história"] },
  { week: 7, phase: "Antecipação",   color: "#EF4444", tasks: ["Últimos dias de captação orgânica", "Anunciar data de abertura do carrinho", "Preparar lista VIP para abertura antecipada", "Revisar página de vendas e finalização de compra"] },
  { week: 8, phase: "Vendas 🔥",     color: "#F97316", tasks: ["Abertura do carrinho — Black Friday", "1 reel + 3–5 stories diários + e-mail diário", "Live de apresentação e abertura de carrinho", "Recuperação de carrinho abandonado", "Live de fechamento com Perguntas e Respostas nas últimas horas"] },
]
...
const defaultNarrativa = [
  ...
  "💥 Desconto surreal — nunca visto antes",
  "📦 Combo de Infoprodutos · Acesso Vitalício",
  "🛡️ Suporte por 1 ano incluso",
  "🎯 Você nunca mais vai gastar com curso de [NICHO] pelo resto da vida",
]
...
const defaultConfig = {
  ...
  eventDate: "22/10",
  productValue: "$200",
  productAccess: "Acesso Vitalício",
  investmentValue: "$20.000",
  investmentDesc: "Investimento total no lançamento",
  cplValue: "$1,00",
  cplDesc: "por lead captado",
  leadsGoal: "20.000",
  leadsDesc: "leads para o lançamento",
}
  ...
  return (
    <li className="flex items-start gap-3 group">
      <button
        ...
        title={checked ? "Marcar como pendente" : "Marcar como concluída"}
      >
        {checked
  ...
  return (
    <div className="mt-4">
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-xs text-[#999]">{done} de {total} tarefas concluídas</span>
        ...
        <div className="p-5">
          {isInstagram ? (
            ...
            <div className="aspect-[9/16] max-h-[60vh] bg-[#f5f5f5] rounded-xl flex flex-col items-center justify-center gap-3 mx-auto">
              ...
              <p className="text-sm font-semibold text-[#999]">Vídeo de exemplo</p>
              <p className="text-xs text-[#ccc]">Adicione a URL do vídeo para visualizar</p>
            </div>
          )}
        </div>
        <div className="px-5 pb-5">
          <button onClick={onClose}
            ...
            <span className="flex items-center justify-center gap-2">
              <ExternalLink className="w-4 h-4" /> Entendi
            </span>
          </button>
        </div>
      </motion.div>
  ...
  return (
    <>
      <div className="bg-white border border-[#eee] rounded-2xl overflow-hidden">
        ...
        <div className="px-6 pb-4 flex items-center gap-3">
          <div className="flex-1 flex items-center gap-2">
            ...
            <span className="text-xs text-[#999] flex-shrink-0">{done}/{count} conteúdos</span>
          </div>
          <button
                ...
                return (
                  <div key={id}
                    ...
                    <p className={`flex-1 text-sm font-medium ${isDone ? "text-green-600 line-through" : "text-[#555]"}`}>
                      Conteúdo {String(n).padStart(2, "0")}
                    </p>
      ...
      {showExample && (
        <ExampleModal
          title={title}
          subtitle={`Exemplo de referência · ${desc}`}
          video={exampleVideo || ""}
          color={iconColor}
...
function CTADesignerCard({ checked, onToggle }: { checked: Record<string, boolean>; onToggle: (id: string) => void }) {
  ...
  const ctas = [
    { id: "cta-designer-ig", label: "CTA Instagram", cta: "Comenta Black",     Icon: IGIcon,  color: "#E1306C", bg: "bg-pink-50",   border: "border-pink-200", exampleVideo: "instagram:DQwnDMYD3EC" },
    { id: "cta-designer-tt", label: "CTA TikTok",    cta: "Link na minha bio", Icon: TTIcon,  color: "#161823", bg: "bg-slate-50",  border: "border-slate-200", exampleVideo: "tiktok:7599996747850517772" },
    { id: "cta-designer-tp", label: "CTA Pago",      cta: "Saiba Mais",
      Icon: ({ size }: { size?: number }) => <DollarSign size={size ?? 20} color="#F97316" />,
      color: "#F97316", bg: "bg-orange-50", border: "border-orange-200", exampleVideo: "instagram:DbTMswrR51x" },
  ]
    ...
    <>
      <div className="bg-white border border-[#eee] rounded-2xl p-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="font-semibold text-sm text-[#333]">3 CTAs produzidos pela designer · serão unidos aos conteúdos depois</p>
          </div>
      ...
      {exampleModal && activeCta && (
        <ExampleModal
          ...
          subtitle={`Exemplo de CTA: "${activeCta.cta}"`}
    ...
    <>
      ...
      {exampleIdx !== null && activeItem && (
        <ExampleModal
          ...
          subtitle={`Exemplo de referência · ${activeItem.desc}`}
...
export default function BlackPlanejamento() {
  const [activeWeek, setActiveWeek] = useState<number | null>(null)

  const [checked, setChecked] = useState<Record<string, boolean>>(() => {
    try { return JSON.parse(localStorage.getItem("bf-checklist-2026") || "{}") }
    catch { return {} }
  })

  const [config, setConfig] = useState(() => {
    try { return { ...defaultConfig, ...JSON.parse(localStorage.getItem("bf-config-2026") || "{}") } }
    catch { return { ...defaultConfig } }
  })

  const [entregaveis, setEntregaveis] = useState<string[]>(() => {
    try { return JSON.parse(localStorage.getItem("bf-entregaveis-2026") || "null") || defaultEntregaveis }
    catch { return [...defaultEntregaveis] }
  })

  const [narrativa, setNarrativa] = useState<string[]>(() => {
    try { return JSON.parse(localStorage.getItem("bf-narrativa-2026") || "null") || defaultNarrativa }
    catch { return [...defaultNarrativa] }
  })

  useEffect(() => {
    localStorage.setItem("bf-checklist-2026", JSON.stringify(checked))
  }, [checked])

  useEffect(() => {
    localStorage.setItem("bf-config-2026", JSON.stringify(config))
  }, [config])

  useEffect(() => {
    localStorage.setItem("bf-entregaveis-2026", JSON.stringify(entregaveis))
  }, [entregaveis])

  useEffect(() => {
    localStorage.setItem("bf-narrativa-2026", JSON.stringify(narrativa))
  }, [narrativa])
  ...
  return (
    <div className="min-h-screen bg-white text-[#0a0a0a] font-outfit antialiased">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-[#eee]">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <span className="font-bold text-[#0a0a0a] hidden sm:block">4GO Academy</span>
          </div>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <button onClick={resetAll} title="Resetar progresso"
      ...
      <section className="pt-32 pb-12 px-6 max-w-7xl mx-auto">
        <motion.div initial="hidden" animate="visible" variants={stagger}>
          ...
          <motion.h1 variants={fadeUp} className="text-[clamp(3rem,9vw,7rem)] font-black leading-[1.0] mb-4 tracking-tight">
            ...
            <br /><span className="text-[#bbb]">para criadores.</span>
          </motion.h1>
          ...
          <motion.div variants={fadeUp} className="bg-gradient-to-r from-[#4B6BFB]/5 via-[#8B5CF6]/5 to-[#F97316]/5 border border-[#4B6BFB]/15 rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-5">
            <div className="flex-1">
              <p className="text-sm text-[#666] mb-1">Progresso geral da equipe</p>
              <p className="text-4xl font-black text-[#0a0a0a]">{totalPct}<span className="text-xl text-[#999]">%</span></p>
              <p className="text-xs text-[#999] mt-1">{totalDone} de {totalTasks} tarefas concluídas</p>
            </div>
            <div className="flex-1">
      ...
      <section id="oferta" className="px-6 py-20 max-w-7xl mx-auto border-t border-[#f0f0f0]">
        <SectionHeader label="Oferta & Narrativa" title="A Promessa e o Produto" />
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={stagger} className="grid md:grid-cols-2 gap-4">
          ...
          <motion.div variants={fadeUp} className="md:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-[#4B6BFB] to-[#8B5CF6] rounded-2xl p-6 flex flex-col justify-between text-white">
              <p className="text-white/60 text-xs uppercase tracking-widest mb-2">Nome do Evento</p>
              <EditableText
              ...
              <div className="flex items-center gap-2 mt-4 pt-4 border-t border-white/20">
                ...
                <span className="text-white/70 text-xs uppercase tracking-widest">Abertura · </span>
                <EditableText
            ...
            <div className="bg-white border border-[#eee] rounded-2xl p-6 flex flex-col justify-between">
              <p className="text-[#999] text-xs uppercase tracking-widest mb-2">Valor do Produto</p>
              <EditableText
            ...
            {/* Investimento */}
            <div className="bg-white border border-[#eee] rounded-2xl p-6 flex flex-col justify-between">
              <p className="text-[#999] text-xs uppercase tracking-widest mb-2">Investimento Tráfego / API</p>
              <EditableText
            ...
            {/* CPL */}
            <div className="bg-white border border-[#eee] rounded-2xl p-6 flex flex-col justify-between">
              <p className="text-[#999] text-xs uppercase tracking-widest mb-2">Custo por Lead (CPL)</p>
              <EditableText
          ...
          <motion.div variants={fadeUp} className="bg-[#fafafa] border border-[#eee] rounded-2xl p-7">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-bold text-[#0a0a0a]">Entregáveis</h3>
            </div>
              ...
              {entregaveis.map((item, i) => (
                <li key={i} className="flex items-start gap-3 group">
                  <button
                    ...
                    className="mt-0.5 flex-shrink-0 transition-transform active:scale-90"
                    title={checked[`entrega-${i}`] ? "Marcar como pendente" : "Marcar como concluída"}
                  >
                    {checked[`entrega-${i}`]
          ...
          <motion.div variants={fadeUp} className="bg-gradient-to-br from-blue-50 via-purple-50 to-orange-50 border border-purple-100 rounded-2xl p-7">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-bold text-[#0a0a0a]">Narrativa da Campanha</h3>
            </div>
      ...
      <section id="conteudo" className="px-6 py-20 bg-[#fafafa] border-y border-[#eee]">
        <div className="max-w-7xl mx-auto">
          <SectionHeader label="Conteúdo" title="Produção de Conteúdo" />
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={stagger}>
            ...
            <div className="mb-4">
              <ContentTracker
                ...
                title="Conteúdos de Captação Orgânica"
                desc="Conteúdos para atrair novos leads de forma orgânica"
                iconColor="#8B5CF6" IconComp={Video}
                checked={checked} onToggle={toggle}
                exampleVideo="instagram:DQCVWpIgDpf"
              />
            </div>
            ...
            <div className="mb-4">
              <ContentTracker
                ...
                title="Depoimentos — Melhores Testemunhos"
                desc="Seleção dos melhores depoimentos para prova social na campanha"
                iconColor="#F59E0B" IconComp={Star}
                checked={checked} onToggle={toggle}
                exampleVideo="instagram:DaWrDrEhj5o"
              />
            </div>
            ...
            <div className="mb-4">
              <ContentTracker
                ...
                title="Conteúdos — Os mais visualizados"
                desc="Repostar com CTA da Black Friday no final"
                iconColor="#4B6BFB" IconComp={Play}
                checked={checked} onToggle={toggle}
                exampleVideo="instagram:DPzH3YhkZ9P"
              />
            </div>
            ...
            <motion.div variants={fadeUp} className="mt-4 border border-[#4B6BFB]/20 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-[#0a0a0a]">1 Live de Apresentação da Black Friday + Abertura de Carrinho</p>
                  <p className="text-xs text-[#999] mt-0.5">Roteiro completo disponível no link abaixo</p>
                </div>
              </div>
              <a href="#" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0a0a0a] text-white text-sm font-semibold rounded-xl hover:bg-[#333] transition whitespace-nowrap">
                <FileText className="w-4 h-4" /> Roteiro da Live
              </a>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section id="trafego" className="px-6 py-20 max-w-7xl mx-auto">
        <SectionHeader label="Tráfego" title="Investimento e metas" />
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={stagger}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            {[
              { icon: Calendar,     label: "Dias de Captação",        value: "21–30 dias" },
              { icon: ShoppingCart, label: "Carrinho Aberto",         value: "7–10 dias" },
              { icon: Users,        label: "Meta de Leads",           value: "20.000" },
              { icon: TrendingUp,   label: "Custo por Lead Estimado", value: "$1,00" },
            ].map((item, i) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { icon: DollarSign, label: "Investimento Total",        value: "$20.000" },
              { icon: BarChart3,  label: "Conversão Esperada",        value: "3% a 10%" },
              { icon: TrendingUp, label: "Estimativa de Faturamento", value: "$120k – $400k" },
              { icon: Zap,        label: "ROI Esperado",              value: "6x – 19x" },
            ].map((item, i) => (
              <motion.div key={i} variants={fadeUp} className="bg-[#fafafa] border border-[#eee] rounded-2xl p-5">
      ...
      <section id="base" className="px-6 py-20 bg-[#fafafa] border-y border-[#eee]">
        <div className="max-w-7xl mx-auto">
          <SectionHeader label="Base · Captação por API" title="Disparos e listas" />
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={stagger} className="grid md:grid-cols-3 gap-4">
            <motion.div variants={fadeUp} className="bg-white border border-[#eee] rounded-2xl p-6">
              ...
              <p className="text-[#999] text-xs mb-1">Total de Leads na Lista</p>
              <p className="font-black text-3xl">—</p>
            </motion.div>
            <motion.div variants={fadeUp} className="bg-white border border-[#eee] rounded-2xl p-6">
              <Star className="w-5 h-5 text-[#8B5CF6] mb-3" />
              <p className="text-[#999] text-xs mb-1">Lista de Alunos</p>
              <p className="font-black text-3xl">—</p>
            </motion.div>
            <motion.div variants={fadeUp} className="bg-gradient-to-br from-blue-50 to-purple-50 border border-purple-100 rounded-2xl p-6">
              ...
              <p className="text-[#999] text-xs mb-1">Disparos de API com Imagens</p>
              <p className="font-black text-3xl">4–8</p>
              <p className="text-[#999] text-xs mt-1">sequências programadas</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="links" className="px-6 py-20 max-w-7xl mx-auto">
        <SectionHeader label="Material de Consulta" title="Links e recursos" />
      ...
      <section id="semanas" className="px-6 py-20 bg-[#fafafa] border-y border-[#eee]">
        <div className="max-w-7xl mx-auto">
          <SectionHeader label="Planejamento Semanal" title="8 semanas · passo a passo" />
      ...
      <section id="calendario" className="px-6 py-20 max-w-7xl mx-auto">
        <SectionHeader label="Calendário" title={<>Calendário <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4B6BFB] via-[#8B5CF6] to-[#EF4444]">Black Friday</span></>} />
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={stagger}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#4B6BFB] via-[#8B5CF6] to-[#F97316] flex items-center justify-center">
              <span className="text-white font-bold text-xs">4G</span>
            </div>
            <span className="text-[#999] text-sm">4GO Academy · Black Friday 2026</span>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-[#ccc] text-xs">{totalDone}/{totalTasks} tarefas · {totalPct}% concluído</span>
