        ...
        <div className="container mx-auto px-4" ref={ref}>
          ...
          >
            <a
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 font-outfit text-base font-bold px-6 sm:px-10 py-4 rounded-[70px] text-white uppercase tracking-fire transition-all duration-300 hover:scale-[1.02]"
              style={{
